...
- (void)parseInboxData:(NSData *)data
{
    ...
    {
        DLog(@"*** Neemware Error: Unable to parse data.  Did you include the -ObjC flag in 'Other Linker Flags' under Build Settings?  If you did and this error is still occuring, please contact Neemware support.");
...
{
    DLog(@"Neemware: Error loading inbox data: %@", error.localizedDescription);
}
